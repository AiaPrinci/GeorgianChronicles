...
const LogIn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://georgianchroniclesbackend.onrender.com/login', loginData, { withCredentials: true });

            const statusResponse = await axios.get('https://georgianchroniclesbackend.onrender.com/auth-status', { withCredentials: true });
